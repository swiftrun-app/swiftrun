// SwiftRun v2 - SQLite database layer (better-sqlite3).
// All queries use prepared statements with bound parameters. No string interpolation.
...
// Resolve DB path relative to the backend/ directory unless absolute.
const backendDir = path.resolve(__dirname, '..');
const rawDbPath = process.env.DB_PATH || './data/swiftrun.db';
const DB_FILE = path.isAbsolute(rawDbPath) ? rawDbPath : path.resolve(backendDir, rawDbPath);
